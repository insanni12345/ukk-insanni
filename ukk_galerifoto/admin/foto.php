                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        <form action="../config/aksi_foto.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="file" class="form-control" name="lokasifille" required>
                ...
                <div class="card mt-2">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $no++ ?></td>
                                <td><img src="../img/<?php echo $data['lokasifille'] ?>" width="100"></td>
                                ...
                                while ($data_album = mysqli_fetch_array($sql_album)){?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <img src="../img/<?php echo $data['lokasifille']  ?>"
                                                                    width="100">
                                                            </div>
                                                            <div class="col-md-8">
